...
struct ImageScale{
	...
	ImageScale(const cv::Mat& I, double r = 5);
...
//=========================================class functions==============================================//
	...
	double difference(const  VLD& vld2)const{
		double diff[2];
		diff[0]=0;
		diff[1]=0;
...
//==================KVLD algorithm======================//
//Output specification: output matches are 1-to-1 matches, multiple matches with one point is not allowed (or you can deactive this verification part in the code) 
//
//I1, I2: input images,
// 
